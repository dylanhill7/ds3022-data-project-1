...
SELECT
    ...
    t.trip_distance / (EXTRACT(EPOCH FROM t.tpep_dropoff_datetime - t.tpep_pickup_datetime) / 3600.0) AS avg_mph,
...
FROM {{ source('emissions', 'yellow_taxi_all_years_clean') }} t
